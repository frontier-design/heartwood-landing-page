...
/* Extends the real Grid so the overlay can never drift out of sync
   with the layout — columns, gaps, padding, and breakpoints all come
...
function GridOverlay() {
  ...
  useEffect(() => {
    const handleKeyPress = (e) => {
      // Ignore key repeats, modifier combos (e.g. Cmd+G), and typing in fields
