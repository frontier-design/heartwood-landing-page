...
var Ae = (function() {
  function e(e2, n, o2) {
    ...
    var r2 = this;
    this.options = __assign(__assign({}, Ne), e2), this.gs = n, this.names = new Map(o2), this.server = !!e2.isServer, !this.server && p && Ee && (Ee = false, ve(this)), ne(this, function() {
      return (function(e3) {
...
var Xe = Je.Consumer;
function Ze() {
  var e = !h && import_react.default.useContext ? import_react.default.useContext(Je) : void 0;
  if (!e) throw se(18);
  return e;
}
function Ke(e) {
  if (h || !import_react.default.useContext || !import_react.default.useMemo) return e.children;
...
function tt(e, s, i) {
  var a2 = Z(e), c2 = e, u2 = !j(e), d2 = s.attrs, p2 = void 0 === d2 ? S : d2, f2 = s.componentId, m2 = void 0 === f2 ? (function(e2, t) {
  ...
  })(e) : y2, E2 = s.displayName && s.componentId ? "".concat(A(s.displayName), "-").concat(s.componentId) : s.componentId || m2, N2 = a2 && c2.attrs ? c2.attrs.concat(p2).filter(Boolean) : p2, P2 = s.shouldForwardProp;
  ...
  function D2(e2, s2) {
    return (function(e3, s3, i2) {
      var a3 = e3.attrs, c3 = e3.componentStyle, u3 = e3.defaultProps, l2 = e3.foldedComponentIds, d3 = e3.styledComponentId, p3 = e3.target, f3 = import_react.default.useContext ? import_react.default.useContext(Je) : void 0, m3 = Ve(), y3 = e3.shouldForwardProp || m3.shouldForwardProp;
      ...
      })(a3, s3, v3), S2 = g2.as || p3, E3 = {};
      for (var N3 in g2) void 0 === g2[N3] || "$" === N3[0] || "as" === N3 || "theme" === N3 && g2.theme === v3 || ("forwardedAs" === N3 ? E3.as = g2.forwardedAs : y3 && !y3(N3, S2) || (E3[N3] = g2[N3], y3 || false || isPropValid(N3) || et.has(N3) || !C.has(S2) || (et.add(N3), console.warn('styled-components: it looks like an unknown prop "'.concat(N3, '" is being sent through to the DOM, which will likely trigger a React console error. If you would like automatic filtering of unknown props, you can opt-into that behavior via `<StyleSheetManager shouldForwardProp={...}>` (connect an API like `@emotion/is-prop-valid`) or consider using transient props (`$` prefix for automatic filtering.)')))));
  ...
  } }), g(v2, E2), T2.warnTooManyClasses = /* @__PURE__ */ (function(e2, t) {
    var n = {}, o2 = false;
    return function(r2) {
...
var ct = (function() {
  ...
  return e.prototype.createStyles = function(e2, t, n, o2) {
    ...
    e2 > 2 && Ae.registerId(this.componentId + e2), this.removeStyles(e2, n), this.createStyles(e2, t, n, o2);
  }, e;
})();
function ut(n) {
  for (var r2 = [], s = 1; s < arguments.length; s++) r2[s - 1] = arguments[s];
  var i = rt.apply(void 0, __spreadArray([n], r2, false)), a2 = "sc-global-".concat(x(JSON.stringify(i))), c2 = new ct(i, a2);
  g(a2);
  var u2 = /* @__PURE__ */ new WeakMap(), l2 = function(e) {
    var n2 = Ve(), r3 = import_react.default.useContext ? import_react.default.useContext(Je) : void 0, s2 = u2.get(n2.styleSheet);
    ...
    })(s2, e, n2.styleSheet, r3, n2.stylis), h || import_react.default.useLayoutEffect(function() {
      return function() {
        c2.removeStyles(s2, n2.styleSheet);
      };
    }, [s2, n2.styleSheet]), h) {
      var d2 = a2 + s2, p2 = "undefined" == typeof window ? n2.styleSheet.getTag().getGroup(de(d2)) : "";
      if (p2) {
        var f2 = I(T(p2) >>> 0), y2 = "sc-global-".concat(a2, "-").concat(s2, "-").concat(f2);
        return import_react.default.createElement("style", { key: y2, "data-styled-global": a2, precedence: "styled-components", href: y2, children: p2 });
      }
    }
    return null;
  };
...
function dt(e) {
  var n = import_react.default.forwardRef(function(n2, r2) {
    var s = b(n2, import_react.default.useContext ? import_react.default.useContext(Je) : void 0, e.defaultProps);
    return void 0 === s && console.warn('[withTheme] You are not using a ThemeProvider nor passing a theme prop or a theme in defaultProps in component class "'.concat(R(e), '"')), import_react.default.createElement(e, __assign(__assign({}, n2), { theme: s, ref: r2 }));
  });
  return n.displayName = "WithTheme(".concat(R(e), ")"), J(n, e);
}
var pt = (function() {
  function e() {
    var e2 = this;
...
export {
  ...
  ke as StyleSheetConsumer,
  je as StyleSheetContext,
